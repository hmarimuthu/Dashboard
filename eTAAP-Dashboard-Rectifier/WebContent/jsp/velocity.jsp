...
<html>
<head>
	<title>eTAAP Dashboard - Velocity</title>
		...
		<form id="default_form" action="filter" method="post">
	    	...
	    	<section>
	        	...
	        	<article style="width:95%">
					<%@ include file="./velocity_content.jsp" %>
	        	</article>
...
<!-- 	<style type="text/css">
	...
	<script type="text/javascript" src='<c:url value="/js/velocity.js" />'></script>
	<script type="text/javascript" src='<c:url value="/js/velocity_chart.js" />'></script>
</html>
